...
This directory covers the fundamentals of Python programming.
It is designed to build a solid foundation for **data analysis, machine learning,
and software development**.

본 폴더는 파이썬의 기초 문법을 다루며,
데이터 분석 및 개발 역량을 위한 기본기를 체계적으로 정리하는 것을 목표로 합니다.
...
Python basics are the foundation of:
